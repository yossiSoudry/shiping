    ...
    <div className="container mx-auto my-20 flex flex-col items-start px-10 py-10 text-gray font-heebo pt-32">
      ...
      <ul className="list-none flex flex-col gap-6 text-2xl text-black">
        ...
        <li className="flex items-center gap-6">
          ...
          <span className="text-2xl lg:text-4xl">שינוי כתובת ללא עלות</span>
        </li>
        <li className="flex items-center gap-6">
          <div className="relative flex-shrink-0 w-16 h-16">
            <Image
          ...
          <span className="text-2xl lg:text-4xl">יצירת קשר בכל הדרכים - טלפון, מסרונים, וואטסאפ ואימייל</span>
        </li>
      </ul>
    </div>
  );
